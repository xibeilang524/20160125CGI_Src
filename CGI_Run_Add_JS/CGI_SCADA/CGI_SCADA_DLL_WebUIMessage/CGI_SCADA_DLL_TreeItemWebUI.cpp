#include "CGI_SCADA_DLL_TreeItemWebUI.h"
...
CGI_SCADA_DLL_I * CreateDriver(QObject *parent)
{
    ...
    CGI_SCADA_DLL_TreeItemWebUI *testProtocol = new CGI_SCADA_DLL_TreeItemWebUI(strings,CGI_SCADA_DLL_I::TreeItemType_Web_UIM,parent);
    qDebug()<<testProtocol->text(0);
    return  testProtocol;
}

CGI_SCADA_DLL_TreeItemWebUI::CGI_SCADA_DLL_TreeItemWebUI(const QStringList &strings, int type, QObject *parent):
