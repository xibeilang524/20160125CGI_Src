...
CGI_SCADA_DLL_TreeItemCurrent_project::CGI_SCADA_DLL_TreeItemCurrent_project(QTreeWidgetItem *parentTreeItem_, const QStringList &strings, int type, QObject *parent):
...
CGI_SCADA_DLL_TreeItemCurrent_project::~CGI_SCADA_DLL_TreeItemCurrent_project()
{
//    if (m_pWidget != NULL)
//    {
...
QWidget *CGI_SCADA_DLL_TreeItemCurrent_project::GetWidget(QTreeWidgetItem *)
{
//    if (m_pWidget == NULL)
//    {
//        m_pWidget = new UI_Current_project(NULL);
//    }
//    return m_pWidget;
